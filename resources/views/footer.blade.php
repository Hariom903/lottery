        ...
        <div class="row footer-top-area pb-4">
            ...
            <div class="col-lg-2 col-sm-6 mb-4">
                ...
                <ul class="menu-list list-unstyled text-uppercase">
                    ...
                    <li class="menu-item pb-2">
                        <a href="{{ route('privacy.notice') }}" class="text-white text-decoration-none">Privacy
                            Notice</a>
                    </li>
                    <li class="menu-item pb-2">
            ...
            <div class="col-lg-3 col-sm-12 mb-4">
                ...
                <p class="mb-2">Have queries or suggestions? <br>
                    <a href="mailto:info@ignisitsolutions.com"
                        class="text-white text-decoration-underline">info@ignisitsolutions.com</a>
                </p>
            ...
            <div class="col-lg-4  align-items-center d-flex col-sm-12 mb-4">
                <form action="{{ route('subscribe') }}" method="POST" class="d-flex  gap-2 my-3">
                    @csrf

                    <input type="email" name="emailsub" class="form-control" placeholder="Enter your email">
                    <button type="submit" class="btn btn-light rounded-4   text-primary">Subscribe</button>
                </form>
                @error('emailsub')
            ...
            <div
                class="col-lg-1 col-sm-12 mb-4 d-flex align-items-center justify-content-lg-end justify-content-center">
                <img src="{{ asset('images/logo.png') }}" alt="Logo"
                    style="max-width: 110px; background: #fff; border-radius: 12px; padding: 8px;">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 text-center text-md-start mb-2 mb-md-0">
                <p class="m-0 small">Gradient Able &#9829; crafted by Team
                    <a href="http://hariom.ct.ws" target="_blank" class="text-white text-decoration-underline">Hariom
                        Dangi</a>
                </p>
            </div>
